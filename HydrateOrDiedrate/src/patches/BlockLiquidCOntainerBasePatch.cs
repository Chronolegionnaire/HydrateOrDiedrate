...
namespace HydrateOrDiedrate.HarmonyPatches
{
    ...
    public static class Patch_BlockLiquidContainerBase_TryFillFromBlock
    {
        ...
        )
        {
            ...
            if (be is not BlockEntityWellWaterData wellWaterData) return true;
            ...
            contentStack.StackSize = (int)(transferLitres * 1000);
            ...
            __instance.DoLiquidMovedEffects(byEntity as IPlayer, contentStack, volumeToTake, BlockLiquidContainerBase.EnumLiquidDirection.Fill);
            __result = true;
            return false;
        }
    }
