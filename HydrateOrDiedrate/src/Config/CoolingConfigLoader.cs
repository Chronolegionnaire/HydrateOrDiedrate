            ...
            if (!File.Exists(configPath))
            {
                var defaultConfig = new JObject
                {
                    ...
                    ["patches"] = new JArray   
                    {
                        ...
                        new JObject { ["itemname"] = "eldritchcuteclothing:clothes-upperbody-kosovorotka-*", ["cooling"] = 2 },
                        ...
                        new JObject { ["itemname"] = "hideandfabric:clothes-lowerbody-homespun-cottonpants", ["cooling"] = 1.5 },
                        new JObject { ["itemname"] = "hideandfabric:clothes-lowerbody-homespun-woolenleggings", ["cooling"] = 0.5 },
                        ...
                        new JObject { ["itemname"] = "simplefabric:clothes-face-*", ["cooling"] = 0.2 },
                        new JObject { ["itemname"] = "simplefabric:clothes-face-*", ["cooling"] = 0.2 },
                        new JObject { ["itemname"] = "simplefabric:*foot*", ["cooling"] = 4 },
                        new JObject { ["itemname"] = "simplefabric:clothes-lowerbody-furl*", ["cooling"] = 1 },
                        new JObject { ["itemname"] = "simplefabric:clothes-upperbodyover-furt*", ["cooling"] = 0.5 },
                        new JObject { ["itemname"] = "simplefabric:clothes-Head-*", ["cooling"] = 2 },
                        new JObject { ["itemname"] = "simplefabric:clothes-lowerbody-*", ["cooling"] = 1.5 },
                        new JObject { ["itemname"] = "simplefabric:clothes-shoulder-*", ["cooling"] = 1.5 },
                        new JObject { ["itemname"] = "simplefabric:clothes-upperbody-shirt-*", ["cooling"] = 1.5 },
                        new JObject { ["itemname"] = "simplefabric:clothes-upperbody-tunic-*", ["cooling"] = 1.5 },
                        new JObject { ["itemname"] = "simplefabric:clothes-upperbody-exomis-*", ["cooling"] = 2 },
                        new JObject { ["itemname"] = "simplefabric:clothes-upperbodyover-*", ["cooling"] = 1.5 },
                        new JObject { ["itemname"] = "simplefabric:clothes-waist-*", ["cooling"] = 0.3 }
                    },
                };
